...
namespace RectangleTrainer.Compass.UI
{
    public abstract class ACompass : MonoBehaviour
    {
        ...
        protected Dictionary<EntityId, ATrackableIcon> icons;
        ...
        protected virtual void Awake() {
            ...
            icons = new Dictionary<EntityId, ATrackableIcon>();
        ...
        public static void AddTrackable(Trackable trackable) {
            ...
            if (!instance.icons.ContainsKey(trackable.GetEntityId())) {
                ...
                instance.icons.Add(trackable.GetEntityId(), iconInstance);
            }
        }
        ...
        public static void RemoveTrackable(Trackable trackable) {
            ...
            if (instance.icons.ContainsKey(trackable.GetEntityId())) {
                ...
                ACompassElement icon = instance.icons[trackable.GetEntityId()];
                if(icon)
                    Destroy(icon.gameObject);
                
                instance.icons.Remove(trackable.GetEntityId());
            }
        }
        ...
        public static void UpdateIcon(Trackable trackable, float angles, Vector3 delta) {
            ...
            ATrackableIcon icon = instance.icons[trackable.GetEntityId()];
            if (icon == null)
                return;
